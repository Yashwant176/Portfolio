      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
        {projects.map((project) => (
          <motion.div
            ...
            viewport={{ once: true }}
            className="relative bg-black rounded-xl overflow-hidden shadow-[0_10px_25px_rgba(255,255,255,0.15)] hover:shadow-[0_15px_35px_rgba(255,255,255,0.3)] hover:-translate-y-2 transform transition-all duration-300 flex flex-col"
          >
            <img
              src={project.image}
              alt={project.title}
